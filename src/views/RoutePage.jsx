    ...
    <Layout>
        ...
        <div className="feedback__containetr">
          <div className="rating__block">
            ...
            <label htmlFor="1"><input type="radio" name="value" value="1" id="1"/>1</label>
            <label htmlFor="2"><input type="radio" name="value" value="2" id="2"/>2</label>
            <label htmlFor="3"><input type="radio" name="value" value="3" id="3"/>3</label>
            <label htmlFor="4"><input type="radio" name="value" value="4" id="4"/>4</label>
            <label htmlFor="5"><input type="radio" name="value" value="5" id="5"/>5</label>
            <button type="button" className="rating__btn">Оценить</button>
          </div>
          <div className="review__block">
            <form className="review__form" data-id={`${route.id}`}>
              <h3>Оставьте отзыв:</h3>
              <textarea cols="35" rows="10" name="text" placeholder="Текст отзыва..."></textarea>
